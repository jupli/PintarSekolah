...
class DashboardOrtuPage extends StatefulWidget {
  ...
  @override
  _DashboardOrtuPageState createState() => _DashboardOrtuPageState();
}
...
class _DashboardOrtuPageState extends State<DashboardOrtuPage> {
  ...
  Future<void> _fetchAndCacheData(SharedPreferences prefs) async {
    ...
    String day =
        getCurrentDayInEnglish(); // Mengambil nama hari dalam bahasa Inggris (misalnya: "Monday")

    final String url =
        'https://api-pinakad.pintarkerja.com/get_dashboard_OLD3.php?enroll_id=${widget.parentId}&day=$day';
...
// Fetch data by selected day without affecting global `data`
  Future<void> fetchDataByDay(String day) async {
    final String url =
        'https://api-pinakad.pintarkerja.com/kecuk2.php?student_id=${widget.studentId}&day=$day';
