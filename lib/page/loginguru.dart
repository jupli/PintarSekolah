...
class LoginGuruScreen extends StatelessWidget {
  const LoginGuruScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final GlobalKey<FormState> formKey = GlobalKey<FormState>();
    final LoginControllerGuru controller =
        Get.find(); // Get instance of the controller

    bool inputFailed = false; // This is fine as it's not reactive
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: GetBuilder<LoginControllerGuru>(
                          builder: (controller) {
