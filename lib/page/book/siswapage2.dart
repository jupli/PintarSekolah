...
import 'pengajuanpr.dart';
import 'zoom.dart';

class SiswaPage2 extends StatefulWidget {
  final int classId;
  final int sectionId;
  final int studentId;
  final int subjectId;
  ...
  @override
  _SiswaPage2State createState() => _SiswaPage2State();
}

class _SiswaPage2State extends State<SiswaPage2> {
  List<String> subjectNames = []; // List to store subject names
  bool isLoading = true; // To manage loading state
  String? selectedSubject; // Subject selected by the user
  List<Map<String, dynamic>>? selectedSubjectDetails; // Subject details
  ...
  void _fetchSubjectDetailsGabungan(String selectedSubject) async {
    ...
    var data1 = await _fetchSubjectDetails(selectedSubject);
    var data2 = await _fetchSubjectDetails3(selectedSubject);
  ...
  Future<void> _fetchSubjectData() async {
    final url =
        'https://api-pinakad.pintarkerja.com/ambilsubyek.php?class_id=${widget.classId}';
  ...
  Future<List<dynamic>> _fetchSubjectDetails(String selectedSubject) async {
    final url =
        'https://api-pinakad.pintarkerja.com/get_subject_details.php?nilai=$selectedSubject';
  ...
  Future<List<dynamic>> _fetchSubjectDetails3(String selectedSubject) async {
    final url =
        'https://api-pinakad.pintarkerja.com/get_subject_details3.php?nilai=$selectedSubject';
                                ...
                                onChanged: (String? newValue) {
                                  ...
                                  if (newValue != null) {
                                    _fetchSubjectDetailsGabungan(
                                        newValue); // Fetch and combine details
                                  }
                                },
                                items:
                      ...
                      child: selectedSubjectDetails != null &&
                          ...
                          ? Column(
                              children:
                                ...
                                // Fungsi untuk menampilkan button berdasarkan wallType
                                Widget _buildButtonBasedOnWallType(
                                    String wallType) {
                                  switch (wallType) {
                                    case 'homework':
                                      return GestureDetector(
                                          onTap: () async {
                                            // Panggil fungsi API sebelum navigasi

                                            // Navigasi setelah mendapatkan data
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) =>
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: const Color.fromARGB(
                                                  ...
                                                  44,
                                                  114,
                                                  119), // Warna latar belakang
                                              borderRadius: BorderRadius.circular(
                                                  30), // Membuat bentuk elips
                                              boxShadow: [
                                                BoxShadow(
                                                  color: Colors.black
                                                      .withOpacity(
                                    ...
                                    case 'tugas':
                                      return ElevatedButton(
                                        onPressed: () {
                                          // Aksi saat tombol assignment ditekan
                                          print(
                                              "Navigating to Assignment Page...");
                                          // Navigator.push(...) ke halaman lain jika perlu
                                        },
                                        child: Text('Go to Assignment Page'),
                                      );
                                    case 'live':
                                      return GestureDetector(
                                          onTap: () async {
                                    ...
                                    default:
                                      return ElevatedButton(
                                        onPressed: () {
                                          print(
                                              "No specific page for this type");
                                          // Aksi default jika wallType tidak sesuai
                                        },
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 20),
                                          // Panggil fungsi untuk membangun tombol sesuai wallType
                                          _buildButtonBasedOnWallType(
                                              detail['wall_type']),
                                        ],
                                      ),
                                    ),
