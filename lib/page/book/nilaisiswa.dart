...
class NilaiSiswa extends StatefulWidget {
  ...
  @override
  _NilaiSiswaState createState() => _NilaiSiswaState();
}

class _NilaiSiswaState extends State<NilaiSiswa> {
  String? selectedSemester; // Biarkan null untuk tidak ada pilihan default
  bool isLoading = false; // To manage loading state
  List<Map<String, dynamic>>?
      selectedSubjectDetails; // Data detail mata pelajaran

  @override
  void initState() {
    super.initState();
    selectedSemester = null; // Biarkan null, sehingga hint akan muncul
  }
        ...
        appBar: AppBar(
          title: Row(
            children: [
              ...
              Text(
                '${widget.namalengkap} - ${widget.classId}', // Combine both properties in a single string
                style: TextStyle(
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  children: [
                        ...
                        Stack(
                          children: <Widget>[
                            Container(
                              ...
                              height: 48.0,
                              width: 320, // Menyesuaikan lebar dropdown
                              decoration: BoxDecoration(
                                color: Colors.white,
                                borderRadius: BorderRadius.circular(12.0),
                                border: Border.all(
                                  color: Color(0xFF748A9C),
                                  width: 1, // Reduced corner radius
                                ),
                              ),
                              child: DropdownButton<String>(
                                isExpanded:
                                    true, // Memperlebar dropdown agar penuh
                                value: selectedSemester,
                                hint: Align(
                                  alignment: Alignment
                                      .center, // Posisikan teks hint di tengah
                                  child: Text(
                                    'Pilih Semester', // Tampilkan hint jika null
                                    style: TextStyle(
                                      fontSize: 14,
                                      fontFamily: 'Inter',
                                ...
                                onChanged: (String? newValue) {
                                  setState(() {
                                    ...
                                    print(
                                        'Semester Terpilih: $selectedSemester');
                            ...
                            // This is the image you want to overlay in the top-right corner
                            Positioned(
                              right: 0, // Position the image on the right edge
                              top:
                                  0, // Align the image with the top of the container
                              child: Container(
                                width:
                                    70, // Size of the image (you can adjust the size as needed)
                                height: 63, // Size of the image
                                decoration: BoxDecoration(
                    ...
                    // Menampilkan detail mata pelajaran dalam bentuk tabel
                    Padding(
                      ...
                      child: selectedSubjectDetails != null &&
                          ...
                          ? Column(
                              children: [
                                SingleChildScrollView(
                                  // Membungkus DataTable dengan SingleChildScrollView
                                  scrollDirection: Axis
                                      .horizontal, // Membuat tabel bisa digulir secara horizontal
                                  child: DataTable(
                                    columnSpacing:
                                        12, // Memberikan jarak antar kolom
                          ...
                          : Padding(
                              ...
                              child: Text(
                                'Pilih Semester untuk melihat informasi pencapaian Nilai.',
                                style: TextStyle(
                                  fontSize: 14,
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    width: 72,
                    height:
                        120, // Adjusted height to fit text and image properly
                    child: Stack(
                      clipBehavior: Clip
                          .none, // Prevents clipping of overflowing elements
                      children: [
                        ...
                        Positioned(
                          left: 0,
                          top:
                              60, // Adjusted position to prevent overlap with the icon
                          child: SizedBox(
                            width: 72,
                            child: Text(
                              'Absensi',
                        ...
                        Positioned(
                          left: 21,
                          top:
                              18, // Positioned icon correctly inside the container
                          child: Container(
                            width: 30,
                            height: 30,
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                ...
                                fit: BoxFit
                                    .contain, // Ensures proper scaling of the image
                              ),
                            ),
                          ),
                        ),
