...
class _AbsensiGuruState extends State<AbsensiGuru> {
  ...
  Future<void> _fetchSubjectData() async {
    ...
    final url =
        'http://api-pinakad.pintarkerja.com/ambilsubyekguru.php?noidguru=${widget.noidguru}';
    try {
  ...
  Future<void> _fetchSubjectDetails(String? selectedSubject) async {
    ...
    final url =
        'http://api-pinakad.pintarkerja.com/ambilabsenguru.php?nilai=$selectedSubject';
  ...
  List<Map<String, dynamic>> _groupedSubjectDetails() {
    ...
    for (var detail in selectedSubjectDetails!) {
      ...
      String mark =
          detail['timestamp'].toString(); // Mendapatkan nilai dari exam
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: () {
                    ...
                    if (widget.noidguru != null &&
                        widget.mengajar != null &&
                        widget.namaguru != null) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
